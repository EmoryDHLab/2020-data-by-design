...
import NavlineVis from '../vis/dubois/navline/NavlineVis'
  ...
  data: () => ({
    timelineData: {
        ...
        highlights: [[0.7, 0.3, 0.],
            ...
            [0.8, 0., 0., 0.],
            [0, 0.8, 0.3, 0]], //default: transparency = 0 for every block;
        vis: [[1, 4, 2],
              [2, 4, 0, 1, 0],
              [4, 3, 0, 2, 0, 1, 3, 0, 2, 0],
              [1, 2, 0, 3],
              [0, 4, 2, 1]], // 1 -> secHeader, 2 -> images, 3 -> vis, 4 -> text, 0 -> empty
