<template lang="html">
  <svg :width="width" :height="height" viewBox="70 100 600 2500" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g style="transform: translateY(20vh)">
      ...
      <text x="340" y="2150" class="number" fill="#4A4A4A">LEGEND</text>
      <text x="320" y="2220" class="small">Highlight</text>
      <text x="520" y="2220" class="small">Image</text>
      <text x="520" y="2275" class="small">Visualization</text>
      <text x="320" y="2275" class="small">Interactive</text>
    </g>
