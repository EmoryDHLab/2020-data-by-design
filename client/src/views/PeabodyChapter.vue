  ...
  <chapter-scaffold v-bind:curChapter="'Peabody'">
    ...
    <DocRenderer doc-id="1_-FrAZVLYF74Kc1U-fpK6ugrIkqYisZEbI0Z2yVUb0I">
      ...
      <template v-slot:HoverEvent1="{inner}">
        <a class="blue-hover" href="#" @mouseover="overlayPos=7.5">{{inner}}</a>
      </template>
      <template v-slot:HoverEvent2="{inner}">
        <a class="blue-hover" href="#" @mouseover="overlayPos=20.1">{{inner}}</a>
      </template>
      <template v-slot:HoverEvent3="{inner}">
        <a class="blue-hover" href="#" @mouseover="overlayPos=20.6">{{inner}}</a>
      </template>
...
<script>
  ...
  import TestComponent from "../docs-integration/TestComponent";
